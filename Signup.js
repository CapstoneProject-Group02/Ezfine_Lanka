...
import englishContent from './Json/DSE.json';
import sinhalaContent from './Json/DSS.json';
import tamilContent from './Json/DST.json';
    ...
    <div className="bgpdsi">
      ...
      <div className="loginFormdsi">
        <form>
          ...
          <Link to="/login">
            <button className="button2">{content.LoginButton}</button>
          </Link>
          <br></br>
          <input
            className="button2"
