...
import englishContent from "../Components/Driver/Json/OFIE.json";
import sinhalaContent from "../Components/Driver/Json/OFIS.json";
import tamilContent from "../Components/Driver/Json/OFIT.json";
...
const PoliceOfficerInterface = () => {
  ...
  return (
    ...
    <h1>SELECT <span style={{ color: '#E4A80E' }}>OFFENCES</span></h1>
